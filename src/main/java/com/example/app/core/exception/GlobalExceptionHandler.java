...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleNoHandlerFoundException(HttpServletRequest request) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(
            ErrorResponse.of(
                "NOT_FOUND", HttpStatus.NOT_FOUND, "Not found " + request.getRequestURI()));
  }
  ...
  public ResponseEntity<ErrorResponse> handleDomainException(DomainException e) {
    return ResponseEntity.status(e.getStatusCode()).body(ErrorResponse.domainExceptionOf(e));
  }
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(ErrorResponse.methodArgumentNotValidExceptionOf(e));
  }
